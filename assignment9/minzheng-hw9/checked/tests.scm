...
;;;;;;;;;;;;;;;;;;;;;;;;;;
 ...
 ;; 1 simple arithmetic
 (display "expected: (pairof int * int) \n")
 (display "result:　")
 (display (tcheck "pair (-(5,3),5)"))
 (display "\n")
; (display (tcheck "unpair(x y pair(1,2) x)"))
 ;2
 (display "expected: int \n")
 (display "result:　")
 (display (tcheck "unpair(x y pair(5,8) x)"))
 (display "\n")
 ;3
  (display "expected: bool \n")
 (display "result:　")
 (display (tcheck "unpair(x y pair(zero?(0),6) x)"))
 (display "\n")
 ;4
 (display "expected: int \n")
 (display "result:　")
 (display (tcheck "let x=pair(4, 5) in unpair(var1 var2 x  -(var1, var2))"))
 (display "\n")
